    ...
    <body class="font-sans antialiased" style="font-family: 'Poppins', sans-serif;">
        <div class="flex min-h-screen bg-white dark:bg-[#0F172A]">
            ...
            <div class="hidden lg:flex lg:w-[44%] xl:w-2/5 sticky top-0 h-screen flex-col overflow-hidden relative">
                ...
                <!-- Content -->
                <div class="relative z-10 flex flex-col h-full px-6 sm:px-8 lg:px-10 py-6 sm:py-8 lg:py-9 xl:py-10">
                    <!-- Logo -->
                    <div class="flex items-center gap-2.5">
                        <div class="w-9 h-9 rounded-xl bg-[#C62828] flex items-center justify-center shadow-lg shadow-red-900/50">
                            <img src="{{ asset('images/darkmode.png') }}" alt="Avenution" class="w-5 h-5">
                        </div>
                    ...
                    <div class="flex-1 flex flex-col justify-center">
                        <div>
                            <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#C62828]/20 border border-[#C62828]/30 mb-3 sm:mb-4 lg:mb-6">
                            ...
                            <h2 class="text-white mb-2 sm:mb-3 lg:mb-4 font-bold leading-tight" style="font-size: clamp(1.75rem, 2vw, 2.4rem);">
                                Your Personal<br>
                                <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#ef5350] to-[#ff8a80]">AI Nutrition</span><br>
                                Coach
                            </h2>

                            <p class="text-gray-400 mb-5 sm:mb-6 lg:mb-8 leading-relaxed max-w-xs text-xs sm:text-sm">
                                Advanced AI analyzes your body metrics to deliver personalized nutrition plans that actually work for you.
                            </p>

                            <!-- Features -->
                            <div class="space-y-2 sm:space-y-3 lg:space-y-3.5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-gray-300 text-xs sm:text-sm">AI-powered body condition analysis</span>
                                </div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-gray-300 text-xs sm:text-sm">Personalized nutrition plans</span>
                                </div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-gray-300 text-xs sm:text-sm">Real-time progress tracking</span>
                                </div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-gray-300 text-xs sm:text-sm">HIPAA-compliant & secure</span>
                                </div>
                            </div>
                        </div>

                        <!-- Stat card -->
                        <div class="mt-6 sm:mt-8 lg:mt-10 bg-white/5 border border-white/10 rounded-2xl p-3 sm:p-4 backdrop-blur-sm">
                    ...
                    <!-- Testimonial -->
                    <div class="mt-4 sm:mt-5 lg:mt-6 xl:mt-7 bg-white/5 border border-white/10 rounded-2xl p-3 sm:p-4 lg:p-5 backdrop-blur-sm">
            ...
            <div class="flex-1 flex flex-col min-h-screen">
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-800/60">
                    ...
                    <div class="flex lg:hidden items-center gap-2">
                        <div class="w-7 h-7 rounded-lg bg-[#C62828] flex items-center justify-center">
                            <img src="{{ asset('images/darkmode.png') }}" alt="Avenution" class="w-3.5 h-3.5">
                        </div>
                ...
                <div class="flex-1 flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12 overflow-y-auto">
                    <div class="w-full max-w-[340px] sm:max-w-[380px]">
                        {{ $slot }}
                    </div>
                </div>
            </div>
